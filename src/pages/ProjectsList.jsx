...
const ProjectsList = () => {
  ...
  const getAllProjects = async (filterType = 'all', pageNumber = 1) => {
    setLoading(true);
      ...
      gap-16 lg:gap-12">
        ...
        <div className="h-auto w-full flex justify-between items-center">
          ...
          <div className="h-auto w-[40%] text-right">
            ...
            hover:text-white" onClick={() => navigate('/add-project')}>
              Add New
            </button>
          </div>
        </div>
        <div className="h-auto w-full flex justify-start items-center gap-5">
          ...
          <div className="h-auto w-auto">
            ...
            onClick={() => getAllProjects('7days', 1)}>
              7 Days
            </button>
          </div>
          <div className="h-auto w-auto">
            ...
            onClick={() => getAllProjects('30days', 1)}>
              30 Days
            </button>
          </div>
        </div>
        ...
        ${loading || dataLength < 5 ? 'h-auto lg:h-[220px]' : 'h-auto'} `}>
          {
            loading ? (<CardsSkeleton />) : (projects.map((v, i) => {
              return <ProjectCards
              key={i}
              data={v}
        ...
        <div className={`h-auto w-auto
          ...
          <div className="join grid grid-cols-3">
            ...
            disabled={page === 1}
            onClick={() => getAllProjects(filter, page - 1)}>
              Previous page
            </button>
            <button className="join-item btn btn-outline text-activeColor
            hover:text-white font-text font-medium"
